...
const JobField = (props) => {
  return (
    <div className="job__status-list job__status-list--add">
      ...
      {props.icon ? (
        <svg className="big-svg job__status-list--priority" fill={props.fill} style={{transform: props.rotate}} >
    ...
    <div className="job">
      ...
      {props.icon ? (
        <>
          ...
          <JobField jobDetails={props.jobDetails[0]} icon={props.icon} priority="High" fill="#D80027" />
          <JobField jobDetails={props.jobDetails[1]} icon={props.icon} priority="Medium" fill="#FB7925" />
          <JobField jobDetails={props.jobDetails[2]} icon={props.icon} priority="Low" fill="#686868" rotate="rotate(180deg" />
        </>
      ) : (
        <>
